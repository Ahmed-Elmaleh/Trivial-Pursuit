...
public class GameBoard {
	...
	public GameBoard(String title) {
		frame = new JFrame();
		frame.setTitle("Trivial Purfuit");
		frame.setBounds(100, 100, 1102, 845);
		...
		frame.getContentPane().add(btnWedge);
		...
		frame.getContentPane().add(btnRagain);
		...
		frame.getContentPane().add(btnPlayer_2);
		...
		frame.getContentPane().add(btnPlayer_1);
		...
		textArea.setText("Welcome to Trivial Purfuit! To start the game, click the \"START GAME\" button. You will be asked to prived the number of players. To start your move, click on \"ROLL DICE\" button. Then decide where you would like to move by clicking your choice on the board, either clockwise or counter-clockwise. Answer the question. then click \"OK\" button. If you land on a wedge tile, you have opportunity to play for a wedge. To get a wedge, you have to asnwer the wedge question correctly. The first player to go around the board and get all the wedges will be allowed to go to the middle of the board. The first player to answer a question from the center of the board wins the game.\n\nGood luck!");
