...
public class UserInterface{
	...
	private void initialize() {
		...
		frmUserInterface.setTitle("Trivial Purfuit");
		frmUserInterface.setBounds(100, 100, 1102, 845);
		...
		frmUserInterface.getContentPane().add(button_1);
		...
		frmUserInterface.getContentPane().add(button_2);
		...
		frmUserInterface.getContentPane().add(button_6);
		...
		frmUserInterface.getContentPane().add(button);
		...
		frmUserInterface.getContentPane().add(button_3);
		...
		frmUserInterface.getContentPane().add(button_4);
		...
		frmUserInterface.getContentPane().add(button_8);
		...
		frmUserInterface.getContentPane().add(button_9);
		...
		frmUserInterface.getContentPane().add(button_11);
		...
		frmUserInterface.getContentPane().add(button_12);
		...
		frmUserInterface.getContentPane().add(button_13);
		...
		frmUserInterface.getContentPane().add(btnPl);
		...
		frmUserInterface.getContentPane().add(button_15);
		...
		frmUserInterface.getContentPane().add(btnPlayer_1);
		...
		frmUserInterface.getContentPane().add(button_38);
		...
		frmUserInterface.getContentPane().add(button_39);
		...
		frmUserInterface.getContentPane().add(button_40);
		...
		frmUserInterface.getContentPane().add(button_41);
		...
		frmUserInterface.getContentPane().add(button_42);
		...
		frmUserInterface.getContentPane().add(button_43);
		...
		frmUserInterface.getContentPane().add(button_44);
		...
		frmUserInterface.getContentPane().add(button_45);
		...
		frmUserInterface.getContentPane().add(button_46);
		...
		frmUserInterface.getContentPane().add(button_47);
		...
		frmUserInterface.getContentPane().add(button_17);
		...
		frmUserInterface.getContentPane().add(button_18);
		...
		frmUserInterface.getContentPane().add(button_19);
		...
		frmUserInterface.getContentPane().add(button_21);
		...
		frmUserInterface.getContentPane().add(button_22);
		...
		frmUserInterface.getContentPane().add(button_23);
		...
		frmUserInterface.getContentPane().add(button_24);
		...
		frmUserInterface.getContentPane().add(button_25);
		...
		frmUserInterface.getContentPane().add(button_26);
		...
		frmUserInterface.getContentPane().add(button_27);
		...
		frmUserInterface.getContentPane().add(button_28);
		...
		frmUserInterface.getContentPane().add(button_29);
		...
		frmUserInterface.getContentPane().add(button_30);
		...
		frmUserInterface.getContentPane().add(button_31);
		...
		frmUserInterface.getContentPane().add(button_32);
		...
		frmUserInterface.getContentPane().add(button_33);
		...
		frmUserInterface.getContentPane().add(button_34);
		...
		frmUserInterface.getContentPane().add(button_35);
		...
		frmUserInterface.getContentPane().add(button_36);
		...
		frmUserInterface.getContentPane().add(button_37);
		...
		frmUserInterface.getContentPane().add(button_48);
		...
		frmUserInterface.getContentPane().add(button_49);
		...
		frmUserInterface.getContentPane().add(button_50);
		...
		frmUserInterface.getContentPane().add(button_51);
		...
		frmUserInterface.getContentPane().add(btnRa);
		...
		frmUserInterface.getContentPane().add(button_53);
		...
		frmUserInterface.getContentPane().add(button_54);
		...
		frmUserInterface.getContentPane().add(button_55);
		...
		frmUserInterface.getContentPane().add(btnPlayer);
		...
		frmUserInterface.getContentPane().add(button_57);
		
		JButton btnNewGame = new JButton("START GAME");
		btnNewGame.setBounds(806, 24, 135, 58);
		frmUserInterface.getContentPane().add(btnNewGame);
		
		JButton btnExitGame = new JButton("EXIT GAME");
		btnExitGame.setBackground(Color.RED);
		btnExitGame.setBounds(806, 714, 135, 58);
		frmUserInterface.getContentPane().add(btnExitGame);
		...
		textArea.setBounds(806, 108, 250, 559);
		frmUserInterface.getContentPane().add(textArea);
